...
import { AlertTriangle, CheckCircle, Info, XCircle, ArrowLeft, Activity } from "lucide-react";
...
const riskConfig = {
  low: { color: "text-healthy", track: "bg-healthy" },
  moderate: { color: "text-warning", track: "bg-warning" },
  high: { color: "text-primary", track: "bg-primary" },
  critical: { color: "text-destructive", track: "bg-destructive" },
};
  ...
  return (
    <section className="py-12 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className={`border rounded-2xl p-8 mb-8 ${sev.bg}`}>
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2 flex-wrap">
                ...
                <Badge variant="outline" className={`${sev.color} border-current`}>
                  {sev.label}
                </Badge>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          {/* Model Performance */}
          <div className="lg:col-span-2 bg-gradient-card border border-border rounded-2xl p-6 shadow-card">
        ...
        <div className="bg-gradient-card border border-border rounded-2xl p-6 shadow-card">
          ...
          <div className="mt-6 p-4 rounded-xl bg-secondary/50 border border-border">
            <p className="text-xs text-muted-foreground">
              <strong className="text-foreground">Disclaimer:</strong> This analysis is for educational and decision-support purposes only.
              Results should be interpreted by qualified healthcare professionals. Always consult with a hematologist for clinical decisions.
            </p>
          </div>
        </div>
      </div>
